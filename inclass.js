...
// INCLASS SOLUTION:
//purpiose- find the second largest number in an array.
//input: an array ofnumbers
//output: second largest number

//Plan A - STEPS:
//1) Find largest number
//2) Remove Largest number
//3) remove largest number

// Plan B - STEPS:
// 1) Check each number
// 2) If biggest yet, save as largest and denote old largest to second largest.
// 3) If second largest, forget old second largest.
//
...
//       if (nums[i] > largest) { //if the current is bigger than the current largest
//         largest = nums[i];
//       }
//     }
//
//     // 2) remove largest
//     let smaller = []; //this array will be all the numbers except for the largest one.
//     for (var i = 0; i < nums.length; i++) {
//       if (nums[i] !== largest) {
...
// console.log("The second largest number in the array is: " + junior);


// 05 | containsVowel, not correct***
//
// Write a function called containsVowel that takes a single string and returns true if there is at least one vowel or false otherwise.
...
//           console.log("This word does contain vowels");
//           return true;
//         }
//         return false;
//       }
...
// output: boolean value (is there a vowel?)
  ...
  //       console.log("the letter: " + words[i]);
  //       console.log("the vowel: " + vowels[j]);
  //
  //       if (words[i] === vowels[j]) {
  //         return true;
  //       }
  ...
  //   }
  //   return false;
  //   // 3) When you find one vowel, return true.
  //     let letter = words.split("");
  // }

// containsVowel("Whats up");
